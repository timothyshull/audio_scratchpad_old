...
*/
CDimensionChorus::CDimensionChorus() {
    ...
    m_HPFLeft.flushDelays();
    m_HPFRight.flushDelays();
...
*/
CDimensionChorus::~CDimensionChorus(void) {


}

void CDimensionChorus::cookBiquads() {
    float m_fQ = 0.707;

    float theta_c = 2.0 * pi * m_fHPF_Fc / (float) m_nSampleRate;
    float d = 1.0 / m_fQ;
    ...
    m_HPFRight.m_f_a0 = a0;
    m_HPFRight.m_f_a1 = a1;
    m_HPFRight.m_f_a2 = a2;
    m_HPFRight.m_f_b1 = b1;
    m_HPFRight.m_f_b2 = b2;
}
...
/*
	...
	- call updaters
*/
void CDimensionChorus::updateModules() {
    cookBiquads();

    // setup quad phase
    m_ModDelayLeft.m_uLFOPhase = 0;  // normal
    m_ModDelayRight.m_uLFOPhase = 0; // normal
    ...
    m_ModDelayLeft.m_fModFrequency_Hz = m_fRate_Hz;
    m_ModDelayRight.m_fModFrequency_Hz = m_fRate_Hz;

    m_ModDelayLeft.m_fFeedback_pct = 0;
    m_ModDelayRight.m_fFeedback_pct = 0;

    m_ModDelayLeft.m_fWetLevel = m_fWetMix;
    m_ModDelayRight.m_fWetLevel = m_fWetMix;
...
*/
bool __stdcall CDimensionChorus::prepareForPlay() {
    // Add your code here:
    // call forwarding!
    // CHORUS!
...
*/
bool __stdcall CDimensionChorus::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
    ...
    fDDLOut_L = m_ModDelayLeft.m_fDDLOutput;
    fDDLOut_R = m_ModDelayLeft.m_fDDLOutput;

    // form dimension cross beams
    //
    // invert
    fDDLOut_L *= -1.0;
    fDDLOut_R *= -1.0;
    ...
    // filter
    fDDLOut_L = m_HPFLeft.doBiQuad(fDDLOut_L);
    fDDLOut_R = m_HPFLeft.doBiQuad(fDDLOut_R);

    // scale
    fDDLOut_L *= m_fCrossMix / 100.0;
    fDDLOut_R *= m_fCrossMix / 100.0;

    // add into mix
    pOutputBuffer[0] = fChorusOut_L + fDDLOut_R;
    ...
    if (uNumInputChannels == 2 && uNumOutputChannels == 2)
        pOutputBuffer[1] = fChorusOut_R + fDDLOut_L;
...
//
bool __stdcall CDimensionChorus::userInterfaceChange(int nControlIndex) {
    // just update all
    updateModules();
...
*/
bool __stdcall CDimensionChorus::joystickControlChange(float fControlA, float fControlB, float fControlC,
...
*/
bool __stdcall CDimensionChorus::processSocketAudioBuffer(float *pInputBuffer, float *pOutputBuffer,
...
*/
bool __stdcall CDimensionChorus::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CDimensionChorus::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity) {
    return true;
}

bool __stdcall CDimensionChorus::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff) {
    return true;
}

bool __stdcall CDimensionChorus::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
cData1, unsigned char cData2) {
    return true;
}

// DO NOT DELETE THIS FUNCTION --------------------------------------------------- //
bool __stdcall CDimensionChorus::initUI() {
// ADDED BY SOCKET -- DO NOT EDIT THIS CODE!!! ----------------------------------- //
...
// **--0xDEA7--**
    ...
    ui2.m_pUserCookedFloatData = &m_fWetMix;
    ui2.m_pUserCookedDoubleData = NULL;
    ui2.m_pUserCookedUINTData = NULL;
    ui2.cControlUnits = "%                                                               ";
    ui2.cVariableName = "m_fWetMix";
