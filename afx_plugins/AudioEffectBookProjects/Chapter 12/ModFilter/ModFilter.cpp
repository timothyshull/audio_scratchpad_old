...
*/
bool __stdcall CModFilter::initialize() {
    // Add your code here
...
float CModFilter::calculateCutoffFreq(float fLFOSample) {
    return (m_fMod_Depth_fc / 100.0) * (fLFOSample * (m_fMaxCutoffFreq - m_fMinCutoffFreq)) + m_fMinCutoffFreq;
}

float CModFilter::calculateQ(float fLFOSample) {
    return (m_fMod_Depth_Q / 100.0) * (fLFOSample * (m_fMaxQ - m_fMinQ)) + m_fMinQ;
}


// LEFT LPF: Note same as Resonant LPF from Chapter 6
void CModFilter::calculateLeftLPFCoeffs(float fCutoffFreq, float fQ) {
...
void CModFilter::calculateRightLPFCoeffs(float fCutoffFreq, float fQ) {
    float theta_c = 2.0 * pi * fCutoffFreq / (float) m_nSampleRate;
    float d = 1.0 / fQ;
...
*/
bool __stdcall CModFilter::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
...
*/
bool __stdcall CModFilter::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CModFilter::processRackAFXAudioBuffer(float *pInputBuffer, float *pOutputBuffer,
...
*/
bool __stdcall CModFilter::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CModFilter::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity) {
    return true;
}

bool __stdcall CModFilter::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff) {
    return true;
}

// uModValue = 0->127
bool __stdcall CModFilter::midiModWheel(UINT uChannel, UINT uModValue) {
    return true;
}

// nActualPitchBendValue 		= -8192 -> +8191, 0 at center
// fNormalizedPitchBendValue 	= -1.0  -> +1.0,  0 at center
bool __stdcall CModFilter::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue) {
    return true;
}
...
*/
bool __stdcall CModFilter::midiClock() {

    return true;
}

// any midi message other than note on, note off, pitchbend, mod wheel or clock
bool __stdcall CModFilter::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CModFilter::initUI() {
    // ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
    ...
    ui0.m_pUserCookedFloatData = &m_fMod_Depth_fc;
    ui0.m_pUserCookedDoubleData = NULL;
    ui0.m_pUserCookedUINTData = NULL;
    ui0.cControlUnits = "%                                                               ";
    ui0.cVariableName = "m_fMod_Depth_fc";
    ...
    m_fModRate_fc = 1.000000;
    CUICtrl ui1;
    ui1.uControlType = FILTER_CONTROL_CONTINUOUSLY_VARIABLE;
    ui1.uControlId = 1;
    ui1.bLogSlider = false;
    ui1.bExpSlider = false;
    ui1.fUserDisplayDataLoLimit = 0.200000;
    ui1.fUserDisplayDataHiLimit = 10.000000;
    ...
    ui2.fUserDisplayDataHiLimit = 3.000000;
    ...
    ui2.m_pUserCookedUINTData = &m_uLFO_Waveform;
    ui2.cControlUnits = "Units                                                           ";
    ui2.cVariableName = "m_uLFO_Waveform";
    ui2.cEnumeratedList = "sine,saw,tri,square";
    ...
    ui3.m_pUserCookedFloatData = &m_fMod_Depth_Q;
    ui3.m_pUserCookedDoubleData = NULL;
    ui3.m_pUserCookedUINTData = NULL;
    ui3.cControlUnits = "%                                                               ";
    ui3.cVariableName = "m_fMod_Depth_Q";
    ...
    ui5.m_pUserCookedUINTData = &m_uLFO_Phase;
    ui5.cControlUnits = "";
    ui5.cVariableName = "m_uLFO_Phase";
    ui5.cEnumeratedList = "NORM,QUAD";
