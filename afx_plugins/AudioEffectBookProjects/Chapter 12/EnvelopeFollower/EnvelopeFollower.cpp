...
*/
CEnvelopeFollower::~CEnvelopeFollower(void) {
...
*/
bool __stdcall CEnvelopeFollower::initialize() {
    // Add your code here
...
float CEnvelopeFollower::calculateCutoffFreq(float fEnvelopeSample) {
...
void CEnvelopeFollower::calculateLeftLPFCoeffs(float fCutoffFreq, float fQ) {
...
void CEnvelopeFollower::calculateRightLPFCoeffs(float fCutoffFreq, float fQ) {
    float theta_c = 2.0 * pi * fCutoffFreq / (float) m_nSampleRate;
    float d = 1.0 / fQ;
...
bool __stdcall CEnvelopeFollower::prepareForPlay() {
    ...
    if (m_uTimeConstant == digital) {
        ...
        m_LeftDetector.init((float) m_nSampleRate, m_fAttack_mSec, m_fRelease_mSec, true, DETECT_MODE_RMS, false);
        m_RightDetector.init((float) m_nSampleRate, m_fAttack_mSec, m_fRelease_mSec, true, DETECT_MODE_RMS, false);
    }
...
*/
bool __stdcall CEnvelopeFollower::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
...
*/
bool __stdcall CEnvelopeFollower::joystickControlChange(float fControlA, float fControlB, float fControlC,
...
*/
bool __stdcall CEnvelopeFollower::processRackAFXAudioBuffer(float *pInputBuffer, float *pOutputBuffer,
...
*/
bool __stdcall CEnvelopeFollower::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CEnvelopeFollower::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity) {
    return true;
}

bool __stdcall CEnvelopeFollower::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff) {
    return true;
}

// uModValue = 0->127
bool __stdcall CEnvelopeFollower::midiModWheel(UINT uChannel, UINT uModValue) {
    return true;
}

// nActualPitchBendValue 		= -8192 -> +8191, 0 at center
// fNormalizedPitchBendValue 	= -1.0  -> +1.0,  0 at center
bool __stdcall CEnvelopeFollower::midiPitchBend(UINT uChannel, int nActualPitchBendValue,
...
*/
bool __stdcall CEnvelopeFollower::midiClock() {

    return true;
}

// any midi message other than note on, note off, pitchbend, mod wheel or clock
bool __stdcall CEnvelopeFollower::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CEnvelopeFollower::initUI() {
    // ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
    ...
    ui5.m_pUserCookedUINTData = &m_uTimeConstant;
    ui5.cControlUnits = "";
    ui5.cVariableName = "m_uTimeConstant";
    ui5.cEnumeratedList = "analog,digital";
    ...
    ui5.cControlName = "Time Constant";
    ...
    ui6.m_pUserCookedUINTData = &m_uDirection;
    ui6.cControlUnits = "";
    ui6.cVariableName = "m_uDirection";
    ui6.cEnumeratedList = "UP,DOWN";
