...
*/
bool __stdcall CDirectOscillator::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
...
*/
bool __stdcall CDirectOscillator::joystickControlChange(float fControlA, float fControlB, float fControlC,
...
*/
bool __stdcall CDirectOscillator::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CDirectOscillator::midiPitchBend(UINT uChannel, int nActualPitchBendValue,
