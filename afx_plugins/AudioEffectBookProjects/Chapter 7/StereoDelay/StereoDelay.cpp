...
// forwarding function for our member objects
...
*/
bool __stdcall CStereoDelay::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
    ...
    switch (m_uDelayType) {
        case CROSS:
            ...
            // cross the Feedbacks
            m_DDL_Left.setCurrentFeedbackInput(m_DDL_Right.getCurrentFeedbackOutput());
            m_DDL_Right.setCurrentFeedbackInput(m_DDL_Left.getCurrentFeedbackOutput());
            break;

        case NORM: // clear the flags
            m_DDL_Left.m_bUseExternalFeedback = false;
            m_DDL_Right.m_bUseExternalFeedback = false;
            break;

        default:  // deault is NORM operation; clear the flags
            m_DDL_Left.m_bUseExternalFeedback = false;
            m_DDL_Right.m_bUseExternalFeedback = false;
            break;
    }
...
*/
bool __stdcall CStereoDelay::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CStereoDelay::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
