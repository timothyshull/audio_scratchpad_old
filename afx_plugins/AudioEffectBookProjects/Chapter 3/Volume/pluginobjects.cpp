...
void CEnvelopeDetector::init(float samplerate, float attack_in_ms, float release_in_ms, bool bAnalogTC, UINT uDetect,
                             bool bLogDetector) {
    m_fEnvelope = 0.0;
        ...
        case saw:
            if (m_uTableMode == normal)    // normal
            {
                ...
                fQuadPhaseOutSample = dLinTerp(0, 1, m_SawtoothArray[nQuadPhaseReadIndex],
                                               m_SawtoothArray[nQuadPhaseReadIndexNext], fQuadFrac);
            }
            else                        // bandlimited
            {
                ...
                fQuadPhaseOutSample = dLinTerp(0, 1, m_SawtoothArray_BL5[nQuadPhaseReadIndex],
                                               m_SawtoothArray_BL5[nQuadPhaseReadIndexNext], fQuadFrac);
            }
            break;
        ...
        case tri:
            if (m_uTableMode == normal)    // normal
            {
                ...
                fQuadPhaseOutSample = dLinTerp(0, 1, m_TriangleArray[nQuadPhaseReadIndex],
                                               m_TriangleArray[nQuadPhaseReadIndexNext], fQuadFrac);
            }
            else                        // bandlimited
            {
                ...
                fQuadPhaseOutSample = dLinTerp(0, 1, m_TriangleArray_BL5[nQuadPhaseReadIndex],
                                               m_TriangleArray_BL5[nQuadPhaseReadIndexNext], fQuadFrac);
            }
            break;
        ...
        case square:
            if (m_uTableMode == normal)    // normal
            {
                ...
                fQuadPhaseOutSample = dLinTerp(0, 1, m_SquareArray[nQuadPhaseReadIndex],
                                               m_SquareArray[nQuadPhaseReadIndexNext], fQuadFrac);
            }
            else                        // bandlimited
            {
                ...
                fQuadPhaseOutSample = dLinTerp(0, 1, m_SquareArray_BL5[nQuadPhaseReadIndex],
                                               m_SquareArray_BL5[nQuadPhaseReadIndexNext], fQuadFrac);
            }
            break;
...
void CJoystickProgram::incTimer() {
    ...
    if (m_uSampleCount > (UINT) m_nTimerDurationSamples) {
        ...
        if (m_bDirInc)
            m_fTimerDurationMSec =
                    m_nCurrentProgramStep > 0 ? m_pJSProgramTable[JS_PROG_INDEX(m_nCurrentProgramStep - 1, 4)]
                                              : m_pJSProgramTable[JS_PROG_INDEX(m_nNumSteps, 4)];
        else
