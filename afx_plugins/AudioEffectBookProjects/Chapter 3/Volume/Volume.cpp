...
*/
bool __stdcall CVolume::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
...
*/
bool __stdcall CVolume::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CVolume::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
