...
*/
bool __stdcall CSimpleHPF::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
    ...
    if (uNumInputChannels == 2 && uNumOutputChannels == 2) {
        ...
        float xn_1 = m_f_z1_right;

        // Difference Equation
        float yn = m_f_a0_right * xn + m_f_a1_right * xn_1;
...
*/
bool __stdcall CSimpleHPF::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CSimpleHPF::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
