...
*/
bool __stdcall CVolumedB::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
...
*/
bool __stdcall CVolumedB::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CVolumedB::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
