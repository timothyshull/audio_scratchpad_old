...
*/
CRingModulator::~CRingModulator(void) {
...
*/
bool __stdcall CRingModulator::initialize() {
    // Add your code here
...
*/
bool __stdcall CRingModulator::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
...
*/
bool __stdcall CRingModulator::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CRingModulator::processRackAFXAudioBuffer(float *pInputBuffer, float *pOutputBuffer,
...
*/
bool __stdcall CRingModulator::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CRingModulator::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity) {
    return true;
}

bool __stdcall CRingModulator::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff) {
    return true;
}

// uModValue = 0->127
bool __stdcall CRingModulator::midiModWheel(UINT uChannel, UINT uModValue) {
    return true;
}

// nActualPitchBendValue 		= -8192 -> +8191, 0 at center
// fNormalizedPitchBendValue 	= -1.0  -> +1.0,  0 at center
bool __stdcall CRingModulator::midiPitchBend(UINT uChannel, int nActualPitchBendValue,
...
*/
bool __stdcall CRingModulator::midiClock() {

    return true;
}

// any midi message other than note on, note off, pitchbend, mod wheel or clock
bool __stdcall CRingModulator::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CRingModulator::initUI() {
    // ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
