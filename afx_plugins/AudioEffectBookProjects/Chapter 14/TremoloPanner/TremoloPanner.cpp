...
*/
CTremoloPanner::~CTremoloPanner(void) {
...
*/
bool __stdcall CTremoloPanner::initialize() {
    // Add your code here

    return true;
}

float CTremoloPanner::calculateGainFactor(float fLFOSample) {
...
void CTremoloPanner::calculatePannerGainFactor(float fLFOSample, float *pLeftVolume, float *pRightVolume) {
...
*/
bool __stdcall CTremoloPanner::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
...
*/
bool __stdcall CTremoloPanner::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CTremoloPanner::processRackAFXAudioBuffer(float *pInputBuffer, float *pOutputBuffer,
...
*/
bool __stdcall CTremoloPanner::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CTremoloPanner::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity) {
    return true;
}

bool __stdcall CTremoloPanner::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff) {
    return true;
}

// uModValue = 0->127
bool __stdcall CTremoloPanner::midiModWheel(UINT uChannel, UINT uModValue) {
    return true;
}

// nActualPitchBendValue 		= -8192 -> +8191, 0 at center
// fNormalizedPitchBendValue 	= -1.0  -> +1.0,  0 at center
bool __stdcall CTremoloPanner::midiPitchBend(UINT uChannel, int nActualPitchBendValue,
...
*/
bool __stdcall CTremoloPanner::midiClock() {

    return true;
}

// any midi message other than note on, note off, pitchbend, mod wheel or clock
bool __stdcall CTremoloPanner::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CTremoloPanner::initUI() {
    // ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
    ...
    ui0.fUserDisplayDataHiLimit = 25.000000;
    ui0.uUserDataType = floatData;
    ui0.fInitUserIntValue = 0;
    ui0.fInitUserFloatValue = 5.000000;
    ...
    ui1.m_pUserCookedFloatData = &m_fModDepth;
    ui1.m_pUserCookedDoubleData = NULL;
    ui1.m_pUserCookedUINTData = NULL;
    ui1.cControlUnits = "%                                                               ";
    ui1.cVariableName = "m_fModDepth";
    ...
    ui3.m_pUserCookedUINTData = &m_uMode;
    ui3.cControlUnits = "";
    ui3.cVariableName = "m_uMode";
    ui3.cEnumeratedList = "Tremolo,Panner";
