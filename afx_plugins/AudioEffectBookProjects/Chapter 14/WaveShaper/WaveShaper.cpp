...
*/
bool __stdcall CWaveShaper::initialize() {
    // Add your code here
...
*/
bool __stdcall CWaveShaper::prepareForPlay() {
    // Add your code here:
...
*/
bool __stdcall CWaveShaper::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
                                              UINT uNumOutputChannels) {
    // Do LEFT (MONO) Channel; there is always at least one input/one output
    // (INSERT Effect)
    float f_xn = pInputBuffer[0];
...
//
bool __stdcall CWaveShaper::userInterfaceChange(int nControlIndex) {
...
*/
bool __stdcall CWaveShaper::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CWaveShaper::processRackAFXAudioBuffer(float *pInputBuffer, float *pOutputBuffer,
...
*/
bool __stdcall CWaveShaper::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CWaveShaper::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity) {
    return true;
}

bool __stdcall CWaveShaper::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff) {
    return true;
}

// uModValue = 0->127
bool __stdcall CWaveShaper::midiModWheel(UINT uChannel, UINT uModValue) {
    return true;
}

// nActualPitchBendValue 		= -8192 -> +8191, 0 at center
// fNormalizedPitchBendValue 	= -1.0  -> +1.0,  0 at center
bool __stdcall CWaveShaper::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue) {
    return true;
}
...
*/
bool __stdcall CWaveShaper::midiClock() {

    return true;
}

// any midi message other than note on, note off, pitchbend, mod wheel or clock
bool __stdcall CWaveShaper::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CWaveShaper::initUI() {
    // ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
    ...
    ui0.fUserDisplayDataLoLimit = 0.100000;
    ...
    ui3.m_pUserCookedUINTData = &m_uInvertStages;
    ui3.cControlUnits = "Units                                                           ";
    ui3.cVariableName = "m_uInvertStages";
    ui3.cEnumeratedList = "OFF,ON";
    ...
    ui3.cControlName = "Invert Stages";
