...
void CStereoQuadFlanger::updateModDelays() {
    ...
    // map tri and sin to the proper LFOs
    m_ModDelayLeft.m_uLFOType = m_uLFOType == 0 ? 2 : 0;
    m_ModDelayRight.m_uLFOType = m_uLFOType == 0 ? 2 : 0;
...
*/
bool __stdcall CStereoQuadFlanger::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
...
*/
bool __stdcall CStereoQuadFlanger::joystickControlChange(float fControlA, float fControlB, float fControlC,
...
*/
bool __stdcall CStereoQuadFlanger::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CStereoQuadFlanger::midiPitchBend(UINT uChannel, int nActualPitchBendValue,
...
// **--0xDEA7--**
    ...
    ui0.uControlTheme[30] = 1;
    ui0.uControlTheme[31] = 1;
    ...
    ui1.uControlTheme[29] = 1;
    ui1.uControlTheme[30] = 1;
    ui1.uControlTheme[31] = 1;
    ...
    ui2.uControlTheme[29] = 2;
    ui2.uControlTheme[30] = 1;
    ui2.uControlTheme[31] = 1;
    ...
    m_uControlTheme[23] = 4;
    m_uControlTheme[24] = 10;
    m_uControlTheme[25] = 1;
