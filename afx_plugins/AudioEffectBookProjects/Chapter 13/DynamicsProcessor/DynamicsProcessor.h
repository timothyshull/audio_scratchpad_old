...
class CDynamicsProcessor : public CPlugIn {
public:
    ...
    virtual ~CDynamicsProcessor(void);
    ...
    float m_fInputGain_dB;
    float m_fThreshold;
    float m_fAttack_mSec;
    float m_fRelease_mSec;
    float m_fRatio;
    float m_fOutputGain_dB;
    float m_fKneeWidth;
    float m_fLookAheadDelay_mSec;
    UINT m_uStereoLink;
    enum {
        ON, OFF
    };
    ...
    float m_fGRMeterValue_L;
    float m_fGRMeterValue_R;
