...
class CConvolveIt : public CPlugIn {
public:
    ...
    virtual bool __stdcall processVSTAudioBuffer(float **inBuffer, float **outBuffer, UINT uNumChannels,
    ...
    // Add your code here: ----------------------------------------------------------- //
    // --- wave data object for parsing IR
