...
*/
bool __stdcall CMoogLPF::initialize() {
    // Add your code here
...
*/
bool __stdcall CMoogLPF::prepareForPlay() {
    // Add your code here:
    leftMoogLPF.initialize((float) m_nSampleRate);
    rightMoogLPF.initialize((float) m_nSampleRate);

    leftMoogLPF.calculateCoeffsMoog(cutoff, theQ);
    rightMoogLPF.calculateCoeffsMoog(cutoff, theQ);
...
*/
bool __stdcall CMoogLPF::processAudioFrame(float *pInputBuffer, float *pOutputBuffer, UINT uNumInputChannels,
                                           UINT uNumOutputChannels) {
    // output = input -- change this for meaningful processing
    //
    // Do LEFT (MONO) Channel; there is always at least one input/one output
    // (INSERT Effect)
    pOutputBuffer[0] = leftMoogLPF.doMoogLPF(pInputBuffer[0]);
    ...
    if (uNumInputChannels == 2 && uNumOutputChannels == 2)
        pOutputBuffer[1] = rightMoogLPF.doMoogLPF(pInputBuffer[1]);
...
//
bool __stdcall CMoogLPF::userInterfaceChange(int nControlIndex) {
    leftMoogLPF.calculateCoeffsMoog(cutoff, theQ);
    rightMoogLPF.calculateCoeffsMoog(cutoff, theQ);
...
*/
bool __stdcall CMoogLPF::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD,
...
*/
bool __stdcall CMoogLPF::processRackAFXAudioBuffer(float *pInputBuffer, float *pOutputBuffer,
...
*/
bool __stdcall CMoogLPF::processVSTAudioBuffer(float **ppInputs, float **ppOutputs,
...
bool __stdcall CMoogLPF::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity) {
    return true;
}

bool __stdcall CMoogLPF::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff) {
    return true;
}

// uModValue = 0->127
bool __stdcall CMoogLPF::midiModWheel(UINT uChannel, UINT uModValue) {
    return true;
}

// nActualPitchBendValue 		= -8192 -> +8191, 0 at center
// fNormalizedPitchBendValue 	= -1.0  -> +1.0,  0 at center
bool __stdcall CMoogLPF::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue) {
    return true;
}
...
*/
bool __stdcall CMoogLPF::midiClock() {

    return true;
}

// any midi message other than note on, note off, pitchbend, mod wheel or clock
bool __stdcall CMoogLPF::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CMoogLPF::initUI() {
    // ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
    ...
    m_uControlTheme[2] = 0;
    m_uControlTheme[3] = 0;
    m_uControlTheme[4] = 16777215;
    m_uControlTheme[5] = 0;
    m_uControlTheme[6] = 0;
    m_uControlTheme[7] = 0;
    m_uControlTheme[8] = 16777215;
    m_uControlTheme[9] = 0;
    m_uControlTheme[10] = 0;
    m_uControlTheme[11] = 0;
    m_uControlTheme[12] = 16777215;
    m_uControlTheme[13] = 0;
    m_uControlTheme[14] = 20;
    m_uControlTheme[15] = 0;
    m_uControlTheme[16] = 8;
    m_uControlTheme[17] = 0;
    m_uControlTheme[18] = 0;
    m_uControlTheme[19] = 16;
    m_uControlTheme[20] = 0;
    m_uControlTheme[21] = 7;
    ...
    m_uControlTheme[32] = 5789696;
    m_uControlTheme[33] = 16777184;
    m_uControlTheme[34] = 0;
    m_uControlTheme[35] = 13882323;
    m_uControlTheme[36] = 16711680;
